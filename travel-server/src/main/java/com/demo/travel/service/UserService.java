...
import com.demo.travel.dao.UserDao;
import com.demo.travel.entity.User;
import com.demo.travel.util.IdWorker;
import com.demo.travel.util.MailUtil;
...
public class UserService {
		...
		return new Specification<User>() {
			...
			public Predicate toPredicate(Root<User> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
				...
				if (searchMap.get("salt") != null && !"".equals(searchMap.get("salt"))) {
					predicateList.add(
					        cb.like(root.get("salt").as(String.class), "%" + (String) searchMap.get("salt") + "%"));
				}
	...
	public void updateAvatorById(String id, String url) {
		findById(id).setAvator(url);
	}
